 ...
 * @Author: tianjun
 * @CreateTime: 2018-05-21 20:46
 * @Editor: tianjun
 * @UpdateTime: 2018-05-21 20:46
 * @Company: netposa
 * @Version：0.1
 */
@SuppressWarnings("deprecation")
public class RedisAlone {
...
//    	redisPool.close();
	...
	public Jedis getJedis() {
		...
		String ip = config.get("redisIP");
		int port = Integer.parseInt(config.get("redisPort"));
        jedis = new Jedis(ip, port, Integer.valueOf(config.get("redisTimeout")));
//        if (redisPool != null) {
...
//        String ip = config.get("redisIP");
//        int port = Integer.parseInt(config.get("redisPort"));
//        String passwd = config.get("redisPassword");
//        passwd = "".equals(passwd) ? null : passwd;
//        int db = Integer.parseInt(config.get("redisDataDase"));
//        conf.setMaxIdle(Integer.valueOf(config.get("redisMaxIdle")));
//        conf.setMaxTotal(Integer.valueOf(config.get("redisMaxActive")));
//        conf.setMaxWaitMillis(Integer.valueOf(config.get("redisMaxWait")));
//        conf.setMaxIdle(Integer.valueOf(config.get("redisMaxIdle")));
//        redisPool = new JedisPool(conf, ip, Integer.valueOf(port), 4000, passwd, db);
//        jedis = redisPool.getResource();
        return jedis;
    }
