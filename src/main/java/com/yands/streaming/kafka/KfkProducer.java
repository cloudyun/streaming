...
public class KfkProducer {
	 ...
	 *             异常
	 */
	public static boolean sendMessage(String zkConnect, String brokerlist, String topicName, int partitionNum,
			String... messages) throws Exception {
		if (brokerlist == null || brokerlist.equals("") || partitionNum <= 0 || messages == null
				|| messages.length == 0) {
